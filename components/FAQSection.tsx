...
const faqs = [
  {
    ...
    answer: 'decidetogether.in is India\'s premier group buying community for real estate. We help home buyers pool their purchasing power to negotiate institutional-level discounts from developers, making dream homes more affordable.'
  },
  {
    category: 'About Decide Together',
